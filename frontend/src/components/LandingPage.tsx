...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-amber-900 text-yellow-100 bg-wood-pattern p-6">
      <div className="max-w-2xl w-full text-center border-8 border-yellow-800 bg-black bg-opacity-60 p-12 rounded-xl shadow-2xl">
        {/* Title */}
        <h1 className="text-7xl font-serif text-yellow-500 mb-2 drop-shadow-lg tracking-widest uppercase leading-tight">
          Quick<br />Draw
        </h1>
        <h2 className="text-4xl font-serif text-white mb-6 tracking-widest">
          ASL Showdown
        </h2>
        ...
        {/* Description */}
        <p className="text-lg font-mono text-gray-300 mb-10 leading-relaxed">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="bg-transparent hover:bg-yellow-900 hover:bg-opacity-40 text-yellow-400 hover:text-yellow-300 text-xl font-bold py-3 px-8 border-2 border-yellow-700 rounded transition-all hover:scale-105"
          >
